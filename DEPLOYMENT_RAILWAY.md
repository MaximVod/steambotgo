...
2. Откройте созданный файл `.env` и замените `ваш_токен_тестового_бота_здесь` на фактический токен тестового бота

### Запуск приложения локально

1. Убедитесь, что у вас установлен Go (версии 1.22 или выше)
2. Скопируйте .env.example в .env и укажите токен тестового бота
